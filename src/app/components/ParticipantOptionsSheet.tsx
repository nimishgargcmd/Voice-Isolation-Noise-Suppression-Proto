...
interface ParticipantOptionsSheetProps {
  ...
  badge?: PersonBadge;
  /** Self-only: current mic/camera controls lock state — shows a toggleable row when set. */
  controlsLocked?: boolean;
  /** Self-only: fired by the "Lock/Unlock mic & camera" row. */
...
const GLYPHS = {
  ...
  lock: { vb: "0 0 20 20", d: "M10 1.67c-2.62 0-4.75 2.13-4.75 4.75v2.08H4c-1.24 0-2.25 1.01-2.25 2.25v7.25c0 1.24 1.01 2.25 2.25 2.25h12c1.24 0 2.25-1.01 2.25-2.25v-7.25c0-1.24-1.01-2.25-2.25-2.25h-1.25V6.42c0-2.62-2.13-4.75-4.75-4.75Zm3.25 6.83H6.75V6.42a3.25 3.25 0 0 1 6.5 0v2.08Z" },
} as const;
 ...
 */
export function ParticipantOptionsSheet({ open, onClose, id, name, badge, controlsLocked, onToggleControlsLock }: ParticipantOptionsSheetProps) {
