import svgPaths from "./svg-voj4kib3uf";
...
function AiGenerateBadgeIOs() {
  return (
    <div className="bg-[#3d3d3d] content-stretch flex items-center justify-center px-[8.093px] py-[2.023px] relative rounded-[8.093px] shrink-0" data-name="AI generate badge / iOS">
      <p className="font-['SF_Pro:Regular',sans-serif] font-normal leading-[16.185px] relative shrink-0 text-[#d6d6d6] text-[12.139px] text-right" style={{ fontVariationSettings: "'wdth' 100" }}>
        AI generated
      </p>
    </div>
  );
...
function LogoBadge() {
  return (
    <div className="content-stretch flex gap-[4.046px] items-center relative shrink-0" data-name="Logo + badge">
      <Copilot2 />
      <AiGenerateBadgeIOs />
    </div>
  );
...
function OutputHeaderIOs() {
  return (
    <div className="absolute content-stretch flex items-center left-[15px] top-[149px] w-[357.084px]" data-name="Output header / iOS">
      <LogoBadge />
    </div>
  );
}
...
function OutputFeed() {
  return (
    <div className="absolute content-stretch flex items-center left-[15.41px] pb-[10.237px] pt-[6.142px] top-[179px] w-[361.354px]" data-name="Output feed">
      <p className="flex-[1_0_0] font-['SF_Pro_Text:Regular',sans-serif] leading-[24.568px] min-h-px min-w-px not-italic relative text-[17px] text-white tracking-[-0.4402px] whitespace-pre-wrap">{`The team needs to boost user engagement with the 'Aurora' interface by Q3, specifically aiming for a 15% increase in daily active users and a 10-minute improvement in average session duration.`}</p>
    </div>
  );
}
  ...
  return (
    <div className="content-stretch flex flex-col gap-[5.822px] items-start relative rounded-[5.822px] shrink-0" data-name="Content">
      <div className="flex flex-col font-['SF_Pro:Regular',sans-serif] font-normal justify-center leading-[0] relative shrink-0 text-[17px] text-center text-white tracking-[-0.1674px] whitespace-nowrap" style={{ fontVariationSettings: "'wdth' 100" }}>
        <p className="leading-[14.554px]">What is the progress so far?</p>
      </div>
    </div>
  );
}
...
function Button() {
  return (
    <div className="content-stretch flex gap-[8px] items-center justify-center p-[12px] relative rounded-[12px] shrink-0" data-name="Button">
      <div aria-hidden="true" className="absolute border-[#878bfb] border-[0.364px] border-solid inset-[-0.364px] pointer-events-none rounded-[12.364px]" />
      <Content />
      <ArrowEnter />
    </div>
  );
...
function Content1() {
  return (
    <div className="content-stretch flex flex-col gap-[5.822px] items-start relative rounded-[5.822px] shrink-0" data-name="Content">
      <div className="flex flex-col font-['SF_Pro:Regular',sans-serif] font-normal justify-center leading-[0] relative shrink-0 text-[17px] text-center text-white tracking-[-0.1674px] whitespace-nowrap" style={{ fontVariationSettings: "'wdth' 100" }}>
        <p className="leading-[14.554px]">What is Aurora?</p>
      </div>
    </div>
  );
}
...
function Content2() {
  return (
    <div className="content-stretch flex flex-col gap-[5.822px] items-start relative rounded-[5.822px] shrink-0" data-name="Content">
      <div className="flex flex-col font-['SF_Pro:Regular',sans-serif] font-normal justify-center leading-[0] relative shrink-0 text-[17px] text-center text-white tracking-[-0.1674px] whitespace-nowrap" style={{ fontVariationSettings: "'wdth' 100" }}>
        <p className="leading-[14.554px]">What are my team’s KRs?</p>
      </div>
    </div>
  );
}
...
function Shorcuts() {
  return (
    <div className="absolute content-stretch flex gap-[12px] items-center left-px overflow-x-auto overflow-y-clip px-[11.643px] py-[4px] top-[318px] w-[390px]" data-name="Shorcuts">
      <Button />
      <Button1 />
      <Button2 />
    </div>
...
function InputBox() {
  return (
    <div className="absolute h-[48px] left-[14px] top-[378px] w-[370px]" data-name="input box">
      <Group4 />
    </div>
  );
}
      ...
      <div className="-translate-x-1/2 absolute bottom-[89px] h-0 left-[calc(50%+6px)] w-[402px]" data-name="Divider">
        <div className="absolute inset-[-0.5px_0_0_0]">
          <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 402 0.5">
            <line id="Divider" stroke="var(--stroke-0, #323232)" strokeWidth="0.5" x2="402" y1="0.25" y2="0.25" />
          </svg>
        </div>
      </div>
      <Frame2 />
