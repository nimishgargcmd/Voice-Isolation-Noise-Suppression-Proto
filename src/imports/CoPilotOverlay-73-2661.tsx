import svgPaths from "./svg-mp1gk2e7uj";
...
function OutputFeed() {
  return (
    <div className="absolute content-stretch flex items-center left-[15.41px] pb-[10.237px] pt-[6.142px] top-[179px] w-[361.354px]" data-name="Output feed">
      <div className="flex-[1_0_0] font-['SF_Pro_Text:Regular',sans-serif] leading-[0] min-h-px min-w-px not-italic relative text-[17px] text-white tracking-[-0.4402px] whitespace-pre-wrap">
        <p className="leading-[24.568px] mb-0">Here are the action items from the meeting:</p>
        <ul className="list-disc">
          <li className="mb-0 ms-[25.5px]">
            <span className="leading-[24.568px]">Sarah to finalize Q2 roadmap presentation by Friday</span>
          </li>
          <li className="mb-0 ms-[25.5px]">
            <span className="leading-[24.568px]">Engineering team to review API integration proposal</span>
          </li>
          <li className="ms-[25.5px]">
            <span className="leading-[24.568px]">Mark to schedule follow-up with design team next week</span>
          </li>
        </ul>
      </div>
    </div>
