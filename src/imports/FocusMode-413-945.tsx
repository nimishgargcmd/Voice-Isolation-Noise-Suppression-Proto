import svgPaths from "./svg-rewqpivs57";
...
function Frame() {
  return (
    <div className="absolute bg-[rgba(255,255,255,0.1)] content-stretch flex h-[24px] items-center justify-center left-[13px] p-[10px] rounded-[100px] top-[534px]">
...
function Frame1() {
  return (
    <div className="-translate-x-1/2 absolute bg-[rgba(255,255,255,0.2)] content-stretch flex items-center justify-center left-[calc(50%+165px)] p-[10px] rounded-[100px] top-[526px]">
      <FullScreenMaximize />
    </div>
  );
}
...
export default function FocusMode() {
  return (
    <div className="bg-black border-6 border-black border-solid overflow-clip relative rounded-[54px] shadow-[0px_12px_48px_0px_rgba(0,0,0,0.24)] size-full" data-name="Focus mode">
      <Header />
      <Frame />
      <Frame4 />
      <div className="-translate-x-1/2 -translate-y-1/2 absolute h-[222px] left-1/2 rounded-[12px] top-[calc(50%-25px)] w-[390px]" data-name="image">
