import svgPaths from "./svg-iv7o0d0hxl";
...
export default function Frame() {
  return (
    <div className="bg-[rgba(36,36,37,0.7)] content-stretch flex flex-col items-start overflow-clip relative rounded-[24px] size-full">
      <TopRow />
      <ButtomRow />
    </div>
  );
