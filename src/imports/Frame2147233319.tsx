import svgPaths from "./svg-3o4pdasyza";
...
function Back1() {
  return (
    <div className="absolute content-stretch flex gap-[10px] h-[44px] items-center left-[296px] px-[16px] py-[10px] top-[20px]" data-name="Back">
      <Bg1 />
