...
function Agenda() {
  return (
    <div className="absolute content-stretch flex flex-col items-start left-0 overflow-x-clip overflow-y-auto top-[189px] w-[393px]" data-name="Agenda">
...
function Por() {
  return (
    <div className="bg-white h-[2792px] overflow-clip relative shrink-0 w-[393px]" data-name="POR">
      <Agenda />
      <div className="absolute content-stretch flex flex-col items-center left-0 shadow-[0px_0.8px_1.8px_0px_rgba(0,0,0,0.12),0px_0.15px_0.45px_0px_rgba(0,0,0,0.14)] top-[92px] w-[393px]" data-name="Date picker">
      ...
      <div className="absolute bg-white content-stretch flex flex-col items-start left-0 top-0 w-[393px]" data-name="Navigation bar (Teams 2 iOS)">
        <NavigationHeader />
