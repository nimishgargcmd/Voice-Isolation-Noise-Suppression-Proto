import svgPaths from "./svg-ju8gt07vjw";
...
function Button() {
  return (
    <div className="bg-[#212121] content-stretch flex h-[76px] items-center justify-center px-[16px] py-[12px] relative rounded-[20px] shrink-0" data-name="Button">
      <div aria-hidden="true" className="absolute border-[#e0e0e0] border-[0.5px] border-solid inset-0 pointer-events-none rounded-[20px]" />
      <Content />
    </div>
  );
}
...
export default function InnerWrapper() {
  return (
    <div className="content-stretch flex gap-[8px] items-center px-[16px] relative size-full" data-name="Inner wrapper">
      <Button />
      <Button1 />
      <Button2 />
      <Button3 />
