import svgPaths from "./svg-rg9fo5dc86";
...
function Frame1() {
  return (
    <div className="content-stretch flex flex-[1_0_0] flex-col items-start justify-center min-h-px min-w-px relative">
      <p className="font-['SF_Pro_Text:Regular',sans-serif] leading-[22px] not-italic relative shrink-0 text-[#6e6e6e] text-[17px] tracking-[-0.408px] w-[237px] whitespace-pre-wrap">Type a message</p>
    </div>
  );
}
...
function Background1() {
  return <div className="absolute inset-0 rounded-bl-[27px] rounded-br-[27px]" data-name="Background" style={{ backgroundImage: "linear-gradient(90deg, rgba(255, 255, 255, 0.17) 0%, rgba(255, 255, 255, 0.17) 100%), linear-gradient(90deg, rgba(242, 242, 242, 0.2) 0%, rgba(242, 242, 242, 0.2) 100%), linear-gradient(90deg, rgba(24, 24, 26, 0.5) 0%, rgba(24, 24, 26, 0.5) 100%)" }} />;
}
...
function ChatKeyboardWithoutPromptPills() {
  return (
    <div className="absolute bg-[#1f1f1f] content-stretch flex flex-col items-start left-0 pt-[4px] rounded-bl-[24px] rounded-br-[24px] rounded-tl-[4px] rounded-tr-[4px] top-0 w-[390px]" data-name="Chat keyboard without prompt pills">
      <InputArea1 />
      <Keyboard2 />
    </div>
  );
...
function ChatKeyboard() {
  return (
    <div className="absolute h-[310px] left-[725px] top-[195px] w-[390px]" data-name="chat keyboard">
