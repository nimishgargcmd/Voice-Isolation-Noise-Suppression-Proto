import svgPaths from "./svg-uy4cmpux52";
...
function HeaderUi1() {
  return (
    <div className="absolute content-stretch flex flex-col gap-[10px] h-[86px] items-start justify-end left-[174px] top-[340px] w-[393px]" data-name="Header UI">
      <Notification1 />
    </div>
  );
}
...
export default function NotificationUfDs() {
  return (
    <div className="bg-white relative size-full" data-name="Notification UFDs">
      ...
      <div className="absolute font-['SF_Pro:Bold',sans-serif] font-bold leading-[30px] left-[640px] text-[0px] text-[20px] text-black top-[232px] whitespace-nowrap" style={{ fontVariationSettings: "'wdth' 100" }}>
        <p className="mb-0">{`Interpreter `}</p>
        <p className="font-['SF_Pro:Regular',sans-serif] font-normal" style={{ fontVariationSettings: "'wdth' 100" }}>
          notification
        </p>
      </div>
