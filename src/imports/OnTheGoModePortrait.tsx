import svgPaths from "./svg-h94vmbtzup";
  ...
  return (
    <div className="relative shrink-0 size-[32px]" data-name="Mic Off">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 32 32">
        <g id="Mic Off">
          <path d={svgPaths.p19b67700} fill="var(--fill-0, #B2B2B2)" id="Shape" />
        </g>
      </svg>
    </div>
  );
...
export default function OnTheGoModePortrait() {
  return (
    <div className="bg-black border-6 border-black border-solid overflow-clip relative rounded-[54px] shadow-[0px_12px_48px_0px_rgba(0,0,0,0.24)] size-full" data-name="On the go mode / Portrait">
      <Header />
      <Frame2 />
      <Frame />
      <Avatar />
