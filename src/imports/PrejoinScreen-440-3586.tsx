import svgPaths from "./svg-o8nu7z7hm3";
import imgPrejoinAudio from "figma:asset/3c32350895790815d4b2b05b8bfa873d40c997c2.png";
import { imgAvatar } from "./svg-9osl5";
...
function Frame2() {
  return (
    <div className="absolute bg-gradient-to-t content-stretch flex from-[rgba(0,0,0,0)] items-start justify-between left-0 p-[12px] to-[rgba(0,0,0,0.5)] top-0 w-[361px]">
      <Frame3 />
      <Frame4 />
    </div>
  );
...
function PrejoinAudio() {
  return (
    <div className="content-stretch flex flex-[1_0_0] flex-col gap-[87px] h-[434px] items-center min-h-px min-w-px overflow-clip py-[12px] relative rounded-[12px]" data-name="Prejoin/Audio">
      <img alt="" className="absolute inset-0 max-w-none object-cover pointer-events-none rounded-[12px] size-full" src={imgPrejoinAudio} />
      <div className="absolute bg-gradient-to-t bottom-0 content-stretch flex from-[rgba(0,0,0,0.5)] items-start justify-between left-0 p-[12px] to-[rgba(0,0,0,0)] w-[361px]" data-name="Call controlPrejoin">
