import svgPaths from "./svg-hlp7gvsm0i";
...
export default function StageFullscreenMode() {
  return (
    <div className="bg-black border-6 border-black border-solid overflow-clip relative rounded-[54px] shadow-[0px_12px_48px_0px_rgba(0,0,0,0.24)] size-full" data-name="Stage / Fullscreen mode">
      <div className="-translate-x-1/2 -translate-y-1/2 absolute flex h-[683px] items-center justify-center left-1/2 top-[calc(50%-0.5px)] w-[384px]" style={{ "--transform-inner-width": "1200", "--transform-inner-height": "19" } as React.CSSProperties}>
