import svgPaths from "./svg-t9x9dwxkqv";
...
function TileFrame() {
  return (
    <div className="content-stretch flex gap-[8px] items-center pr-[16px] relative shrink-0" data-name="tile frame">
      <Button />
      <Button1 />
      <Button2 />
      <Button3 />
...
export default function VisibleContainer() {
  return (
    <div className="content-stretch flex gap-[8px] items-center px-[16px] py-[12px] relative size-full" data-name="visible container">
      <TileFrame />
    </div>
  );
}