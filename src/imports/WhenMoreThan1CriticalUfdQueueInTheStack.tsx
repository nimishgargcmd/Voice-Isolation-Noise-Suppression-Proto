import svgPaths from "./svg-gc6iklcvw4";
...
export default function WhenMoreThan1CriticalUfdQueueInTheStack() {
  return (
    <div className="content-stretch flex flex-col gap-[10px] items-start justify-end relative size-full" data-name="When more than 1 critical UFD queue in the stack.">
      <Notification />
      <Recording />
    </div>
  );
